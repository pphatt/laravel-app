...
const manageAccountModal = new ManageAccountModal({
    button: document.querySelectorAll("button[data-account-id]") as NodeList,
    modal: document.querySelectorAll("div[data-account-id]") as NodeList,
})
