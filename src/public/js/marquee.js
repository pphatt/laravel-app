...
const products = [
    ...
    },
    {
        ...
        product_figure_1: "https://cdn.sanity.io/images/ieasd5lg/production/8f2d37e1a2e1fa6d5eea191b77432c6c6cdd0adf-2400x1800.jpg?w=1200&amp;q=80&amp;fit=max&amp;auto=format",
    ...
    },
    {
        ...
        product_figure_1: "https://cdn.sanity.io/images/ieasd5lg/production/59718c11fd9e1ab0eae0ed8b91ea7ae410fd2e29-2049x2016.jpg?w=1200&amp;q=80&amp;fit=max&amp;auto=format",
        product_figure_2: "https://cdn.sanity.io/images/ieasd5lg/production/7572c4a211b0f854f562ddc8f58460d0ffbf828e-2049x2016.jpg?w=1200&amp;q=80&amp;fit=max&amp;auto=format",
    ...
    },
    {
        ...
        product_figure_2: "https://m.media-amazon.com/images/I/81A36fe72TL._SL1290_.jpg",
        product_image_alt: "= vinyls - ed sheeran",
        product_price: 24.98,
    },
    {
        product_name: "-",
        product_figure_1: "https://m.media-amazon.com/images/I/91OhLzGyWEL._SL1500_.jpg",
        product_figure_2: "https://m.media-amazon.com/images/I/51ERJnxN5ZL._SL1054_.jpg",
        product_image_alt: "- vinyls - ed sheeran",
        product_price: 24.98,
    },
    {
        product_name: "%",
        product_figure_1: "https://m.media-amazon.com/images/I/B1HYJn9MrPS._SX425_.jpg",
        product_image_alt: "% vinyls - ed sheeran",
        product_price: 36.56,
    },
    {
        product_name: "X",
        product_figure_1: "https://m.media-amazon.com/images/I/711Qha+w8GL._SL1425_.jpg",
        product_image_alt: "X vinyls - ed sheeran",
        product_price: 29.99,
    },
    {
        product_name: "No. 6 Collaborations",
        product_figure_1: "https://m.media-amazon.com/images/I/91igTrfGSsL._SL1500_.jpg",
    ...
    addChildrenSPMarquee() {
        ...
        for (let i = 0; i < 2; i++) {
            ...
            for (let j = 0; j < 2; j++) {
                ...
                for (const { product_name, product_figure_1, product_figure_2, product_image_alt, product_price, product_sale, } of products) {
                    innerMarquee += `
...
const m = new Marquee({
    PMarquee: document.getElementById("-parent-marquee"),
    SPMarquee: document.getElementById("-inner-parent-marquee"),
